            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <div>
                    <a href="/tambahuc" class="text-decoration-none text-white mr-5"><button type="button"
                            ...
                            <i class="ti-plus btn-icon-prepend"></i>Add
                            User
                        </button></a>
                </div>
            </div>
                    ...
                    <table class="table table-striped">
                        ...
                        @foreach ($uc as $item)
                            <tbody>
                                ...
                                @else
                                    <td>
                                        <form onsubmit="return confirm('Are you sure you want to appoint USER to be ADMIN ?')"
                                        ...
                                        <form onsubmit="return confirmDelete(event)" class="d-inline"
                                            action="/deletauc/{{ $item->id }}" method="POST">
                                            @csrf
