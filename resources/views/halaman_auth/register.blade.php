	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form action="{{ route('registerasi') }}" class="login100-form validate-form" method="POST" enctype="multipart/form-data">
                  @csrf
                    ...
                    <div style="margin: 20px 20px 40px 20px;">
                        <label for="image" style="margin-bottom: 10px; font-size: 16pt; color:#666666;">image</label>
                        <input class="input100" type="file" name="image" id="image" style="margin-left: -40px;">
                  </div>
